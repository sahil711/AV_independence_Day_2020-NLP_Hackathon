...
Baker==1.3
basemap==1.2.1
bayesian-optimization @ git+https://github.com/fmfn/BayesianOptimization.git@380b0d52ae0e3650b023c4ef6db43f7343c75dea
bayespy==0.5.19
bcolz==1.2.1
...
catalyst==20.7
catboost==0.24
category-encoders @ git+https://github.com/scikit-learn-contrib/categorical-encoding.git@a810a4b7abfce9fc4eb7fc401e3d37f2c1c6e402
certifi==2020.6.20
cesium==0.9.12
cffi==1.14.0
cftime==1.2.1
...
Janome==0.3.10
jax==0.1.62
jaxlib @ https://storage.googleapis.com/jax-releases/cuda101/jaxlib-0.1.41-cp37-none-linux_x86_64.whl
jdcal==1.4.1
jedi==0.15.2
jeepney==0.4.3
jieba==0.42.1
...
learntools @ git+https://github.com/Kaggle/learntools@1abec6fb79da1aebe9ed2d9a8cdbda23e136d809
leven==1.0.4
libarchive-c==2.9
librosa==0.8.0
lief==0.9.0
...
tensorboardX==2.1
tensorflow @ file:///tmp/tensorflow_gpu/tensorflow-2.3.0-cp37-cp37m-linux_x86_64.whl
